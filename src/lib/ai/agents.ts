...
export class StoryAgents {
  ...
  constructor(deps: AgentDeps = {}) {
    ...
    this.client = new ChatCompletionsClient(this.config, deps.fetcher, null, true);
  }
